...
$clientcount = shell_exec('sudo /var/www/ovpn/admin/getusercount.sh');
$load = sys_getloadavg();

$ovpnactive = shell_exec("sudo /var/www/ovpn/admin/ovpnservicestatus.sh | grep active  | awk '{ print $2 }'");
